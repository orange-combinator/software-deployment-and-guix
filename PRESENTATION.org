...
*** The following comes from Eelco Dolstra's Phd Thesis.
   ...
   - *Note* The rest of this table describes the analogy between
     functional package management and pointer disciplines.
     Functional package management doesn't actually describe perfect
     pointer management like java or lisp or haskell.  It is closer to
     c++ with a reasonable pointer discipline.
